...
const translations: Record<SupportedLanguage, Record<string, string>> = {
  fr: {
    ...
    "ruleWizard.scope.processTypes": "Types de processus",
    "ruleWizard.scope.processTypesHint": "Sélectionnez les processus auxquels cette règle s'applique (vide = tous)",
    "ruleWizard.scope.allProcessesSelected": "ℹ Aucun processus sélectionné - la règle s'applique à tous les processus",
    "ruleWizard.scope.selectedProcessCount": "{count} processus sélectionné(s)",
    "ruleWizard.scope.clearSelection": "Effacer la sélection",
    ...
    "rules.table.allProcesses": "Tous les processus",
  ...
  en: {
    ...
    "ruleWizard.scope.processTypes": "Process types",
    "ruleWizard.scope.processTypesHint": "Select the processes this rule applies to (empty = all)",
    "ruleWizard.scope.allProcessesSelected": "ℹ No process selected - rule applies to all processes",
    "ruleWizard.scope.selectedProcessCount": "{count} process(es) selected",
    "ruleWizard.scope.clearSelection": "Clear selection",
    ...
    "rules.table.allProcesses": "All processes",
