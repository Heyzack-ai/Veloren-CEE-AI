...
async def handler(req, context):
    """Handle approve dossier request."""
    ...
    async with session_maker() as db:
        try:
            ...
            # TODO: Implement dossier approval logic
            ...
            await logger.log(
                ...
                action_type="dossier.approved",
                entity_type="dossier",
                entity_id=str(dossier.id),
                entity_reference=dossier.reference,
                description=f"Dossier {dossier.reference} approved"
            )
            ...
            context.logger.error(f"Error approving dossier: {e}", exc_info=True)
